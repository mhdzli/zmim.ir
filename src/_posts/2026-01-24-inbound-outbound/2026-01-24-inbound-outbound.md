...
اینجا قصد دارم توضیح بدهم که چرا پس از برقراری محدود و مختصر ارتباط پیامهای ارسالی از داخل ایران راحت‌تر در خارج از کشور دیافت می‌شوند و معمولا مسیر برگشت یعنی پیام‌هایی که از خارج از ایران ارسال می‌شوند سخت‌تر به مقصد می‌رسند.
